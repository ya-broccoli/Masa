...
var _initNewsToggle = require("./modules/news/init-news-toggle");
// ---------------------------------
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _initNavToggle.initNavToggles)();
  ...
  (0, _initMap.initMap)();
  (0, _initNewsToggle.toggleCurrent)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/map/init-map":11,"./modules/modals/init-modals":12,"./modules/nav-toggle/init-nav-toggle":14,"./modules/news/init-news-toggle":15,"./modules/select/custom-select":17,"./modules/sliders/init-hero-slider":19,"./modules/sliders/init-news-slider":20,"./modules/sliders/init-programs-slider":21,"./modules/sliders/init-reviews-slider":22,"./utils/ios-vh-fix":25}],2:[function(require,module,exports){
"use strict";
...
var initMap = function initMap() {
  if (myMap) {
    ...
    var coordinate = [55.028553, 82.928182];
    ...
    var map = (0, _leaflet.map)('map', mapOptions);
    var tileLayer = (0, _leaflet.tileLayer)(url);
    tileLayer.addTo(map);
    ...
    var marker = (0, _leaflet.marker)(coordinate, {
      icon: icon
    });
    marker.addTo(map);
  }
...
},{"../../vendor/leaflet":27}],12:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":23,"../../utils/scroll-lock":26}],14:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initNavToggles = void 0;
var navMain = document.querySelector('.header__nav');
var navToggle = document.querySelector('.header__toggle');
// const navLinks = document.querySelectorAll('.header__link');
var overlay = document.querySelector('.overlay');
var initNavToggles = function initNavToggles() {
...
exports.initNavToggles = initNavToggles;
...
exports.toggleCurrent = void 0;
var container = document.querySelector('.news__tabs');
var currentButton = container.querySelector('.news__tab--current');
var toggleCurrent = function toggleCurrent() {
...
exports.toggleCurrent = toggleCurrent;
...
var heroSliderPagination = document.querySelector('.swiper-pagination');
...
var buttonPrev = document.querySelector('.news__control--prev');
var buttonNext = document.querySelector('.news__control--next');
...
var programsNextButton = document.querySelector('.programs__button--next');
var programsPrevButton = document.querySelector('.programs__button--prev');
var programsScrollbar = document.querySelector('.programs__scrollbar');
...
var reviewsNextButton = document.querySelector('.reviews__button--next');
var reviewsPrevButton = document.querySelector('.reviews__button--prev');
var reviewsScrollbar = document.querySelector('.reviews__scrollbar');
